          ...
          <div className="flex flex-col gap-5 justify-center items-center">
            ...
            <div className="lg:w-1/2">
              <p className="text-center">
                ...
                sint, possimus asperiores blanditiis quas quasi dolores numquam
                nisi nesciunt, mollitia eaque voluptates similique
                reprehenderit. Aperiam eligendi perferendis nesciunt nobis
                earum.
              </p>
            </div>
          </div>
